...
### Overview
By the 1400s, a number of regional powers had started to emerge on the borders of [Sembara](<../gazetteer/greater-sembara/sembara/sembara.md>). In the northwest, from the highland provinces of [Drankor](<drankorian-era/drankorian-empire.md>), two realms had emerged: Lavnoch and [Ardlas](<../gazetteer/greater-sembara/zimkova/ardlas.md>). Perched on either side of Lake Derwent, they grew rich with the profit of trade over the mountains, but were often in conflict over control of the lake and access to the Dwarven trade.

North of Lavnoch, the brief Unified Crown of Zovcka had collapsed, and two northern kingdoms emerged: Zovcka, in the north, and [Breva](<../gazetteer/greater-sembara/zimkova/breva.md>), squeezed between [Braebein](<../gazetteer/greater-sembara/sembara/braebein.md>) and the growing power of the Duke of [Arnsbury](<../gazetteer/greater-sembara/sembara/heartlands/duchy-of-arnsbury.md>), the [Sentinel Range](<../gazetteer/sentinel-range/sentinel-range.md>), and Zovcka. 
