...
-
   :octicons-info-24:{ .lg .middle } A [Chardonian](<../../gazetteer/greater-chardon/chardonian-empire/chardonian-empire.md>) magical society  
   :material-calendar: Founded DR 1125 (625 years ago)  
...
The Hetaeri Magica is an ancient magical society, founded in DR 1125 to coordinate rules on the use of magic and magical training between the [Great Library](<../../gazetteer/greater-chardon/chardonian-empire/chardon/great-library.md>) and the [University of Chardon](<../../gazetteer/greater-chardon/chardonian-empire/chardon/university-of-chardon.md>), and subsequently growing into one of the most influential organizations in Chardon. In the modern day, the Hetaeri Magica is responsible for safeguarding magical knowledge and regulating the use of magic across [Precinct IV](<../../gazetteer/greater-chardon/chardonian-empire/chardon/precinct-iv.md>), as well coordinating common rules with the imperial Mageguard, the [Praecanti Vigiles](<praecanti-vigiles.md>). Though the existence of the Hetaeri Magica is not hidden, its membership and governance are not public knowledge. 
