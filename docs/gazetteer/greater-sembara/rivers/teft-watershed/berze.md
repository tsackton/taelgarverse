...
A swift-flowing mountain river that joins the [Teft](<./teft.md>) just west of the [Great Chasm](<../../zimkova/great-chasm.md>). It flows south from the [Sentinels](<../../../sentinel-range.md>).