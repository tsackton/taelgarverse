...
---
# Aesganstrad
:speaker:{ .middle } *(ESS-gahn-strahd)*  
...
One of the ancient original wards of the city of [Tollen](<../tollen.md>), Aesganstrad lies to the north and west along the [Volta](<../../rivers/volta-watershed/volta.md>) from [Fiskurth](<fiskurth.md>). Together with Fiskurth and [Skepwalk](<skepwalk.md>), it forms the ancient core of pre-Drankorian [Tollen](<../tollen.md>); today it is a tangle of narrow streets, leaning houses, and old statues to forgotten heroes.
