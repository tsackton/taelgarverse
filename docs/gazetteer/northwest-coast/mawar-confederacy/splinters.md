...
-    :octicons-location-24:{ .lg .middle } An island chain in the [Mawakel Peninsula](<mawakel-peninsula.md>), the [Northwest Coast](<../northwest-coast.md>)  
    :octicons-location-24:{ .lg .middle } Located offshore from [Hamri](<hamri.md>)  
</div>
