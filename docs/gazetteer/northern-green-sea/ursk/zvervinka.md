...
---
# Zvervinka
:speaker:{ .middle } *(ZVEHR-veen-ka)*  
<div class="grid cards ext-narrow-margin ext-one-column" markdown>
-    :octicons-location-24:{ .lg .middle } A city in [Ursk](<ursk.md>), the [Northern Green Sea](<../northern-green-sea.md>)  
</div>


Zvervinka is a major market city in interior [Ursk](<ursk.md>), set along the lower [Ket](<../rivers/ket.md>) not far from the [Green Sea](<../../green-sea.md>) coast. Heavily fortified and vigilant, it anchors the trade in trophies and reagents of the far north—dragonhide, ice‑worm scales, remorhaz matter, and other dangerous spoils—moving goods downriver and along the coast to [Praznitsky](<praznitsky.md>) and [Zakat](<zakat.md>) for export, or overland toward [Vedmakov](<vedmakov.md>) for domestic use.
...
Unlicensed spellcasting is prohibited inside the walls. Those authorized to work magic do so under recognized papers associated with Ursk’s [rodnya](<../../../groups/urskan-magical-organizations/rodnya.md>) orders, and the [Watchers](<../../../groups/urskan-magical-organizations/eyes-of-vedmakov.md>) patrol markets and gates to enforce compliance. At the [Watcher's Spire](<watcher-s-spire.md>), formal audiences require depositing detectable magic at the entry vestibule. In winters when the wild presses downriver, the walls remain fully manned and wards are closely tended, while the magic of the [Rodnya](<../../../groups/urskan-magical-organizations/rodnya.md>) protects the city.
