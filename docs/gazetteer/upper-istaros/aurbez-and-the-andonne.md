...
-    :octicons-location-24:{ .lg .middle } A region in the [Istaros Watershed](<../major-rivers/istaros-watershed.md>)  
</div>
...
The region is bordered by the [Plaguelands](<./plaguelands.md>) and the [Darkwood](<../greater-sembara/addermarch/darkwood.md>) in the east, the Maseau Gap and the ~Sentinel Range Spur~ in the north (which forms an informal and shifting border with the [Duchy of Maseau](<../greater-sembara/duchy-of-maseau/duchy-of-maseau.md>)), the [Sentinel Range](<../sentinel-range.md>) in the west, and the [Andonne](<rivers/andonne.md>) and [Douren](<rivers/douren.md>) rivers in the south. 
...
### The Aurbez Plateau
The [Aurbez Plateau](<./aurbez-plateau.md>) rises sharply just north of the Dunmar Road, and is the heart of the [Refounded Alliance of Aurbez](<refounded-alliance-of-aurbez/refounded-alliance-of-aurbez.md>). 
