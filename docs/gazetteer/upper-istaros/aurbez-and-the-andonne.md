...
The region is bordered by the [Plaguelands](<plaguelands.md>) and the [Darkwood](<../greater-sembara/addermarch/darkwood.md>) in the east, the [Maseau Gap](<../greater-sembara/maseau-gap.md>) and the [Salt Hills](<../greater-sembara/salt-hills.md>) in the north (which forms an informal and shifting border with the [Duchy of Maseau](<../greater-sembara/duchy-of-maseau/duchy-of-maseau.md>)), the [Sentinel Range](<../sentinel-range.md>) in the west, and the [Andonne](<../major-rivers/istaros-watershed/andonne.md>) and [Douren](<../major-rivers/istaros-watershed/douren.md>) rivers in the south. 
...
The mountainous region stretching south from the headwaters of [Douren](<../major-rivers/istaros-watershed/douren.md>), where the [South Dunmar Road](<south-dunmar-road.md>) clings to a broad shoulder of the [Sentinels](<../sentinel-range.md>), is a region of rocky slopes, dramatic waterfalls, and highland forests. Though few humans settle here, this area is the heart of one of the major [Stoneborn](<../../creatures/species/stoneborn.md>) communities in the southern [Sentinels](<../sentinel-range.md>). 
