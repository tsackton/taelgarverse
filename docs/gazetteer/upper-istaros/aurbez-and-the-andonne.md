...
The region is bordered by the [Plaguelands](<plaguelands.md>) and the [Darkwood](<../greater-sembara/addermarch/darkwood.md>) in the east, the [Maseau Gap](<../greater-sembara/maseau-gap.md>) and the ~Sentinel Range Spur~ in the north (which forms an informal and shifting border with the [Duchy of Maseau](<../greater-sembara/duchy-of-maseau/duchy-of-maseau.md>)), the [Sentinel Range](<../sentinel-range.md>) in the west, and the [Andonne](<../major-rivers/istaros-watershed/andonne.md>) and [Douren](<../major-rivers/istaros-watershed/douren.md>) rivers in the south. 
