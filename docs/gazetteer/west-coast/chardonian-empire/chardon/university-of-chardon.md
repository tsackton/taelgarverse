...
tags: [place, event-source, status/metadata/image]
typeOf: university
whereabouts:
...
The Hetaeri Magica, which draws members from both the University of Chardon and the [Great Library](<./great-library.md>) controls and propagates rules on the use of magic within [Precinct IV](<./precinct-iv.md>), the academic quarter of Chardon. 
## History
