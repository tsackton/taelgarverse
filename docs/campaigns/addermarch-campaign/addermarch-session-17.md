...
name: Addermarch Campaign - Session 17
tagline: in which the party defeats a skeleton host
descTitle: Skeletons at Serethwyn Tor
title: Addermarch Campaign - Session 17
---
...
- **[Yvan Greenrabbit](<../../people/pcs/addermarch/yvan-greenrabbit.md>)**  -  Halfling sorcerer whose fire spells tear through the skeleton ranks.
- **[Drou](<../../people/pcs/addermarch/drou.md>)**  -  Elven bard-monk who takes the brunt of arrows and unleashes thunder magic amid the press of undead.
- **[Fazoth de Brune](<../../people/pcs/addermarch/fazoth-de-brune.md>)**  -  Warlock who sends his pseudodragon to scout and calls a fey ally to hold the line.
- **[Duncan of Haldrenn](<../../people/addermarians/duncan-of-haldrenn.md>)**  -  Missing shepherd whose trail leads to Serethwyn Tor and the cursed axe.
- **Fazoth's pseudodragon**  -  Scout familiar sent over the wall, killed by the skeleton host.
- **Skeleton host of Serethwyn Tor**  -  Undead soldiers with sergeants, captains, and ogre bodyguards guarding the fort.
...
We begin as the party settles into camp for the evening, on the road into the Highmoor, following the trail of [Duncan of Haldrenn](<../../people/addermarians/duncan-of-haldrenn.md>) to uncover the mystery of the cursed [Serpentine Battleaxe](<../../things/magic-items/serpentine-battleaxe.md>) and [Serethwyn Tor](<../../gazetteer/greater-sembara/addermarch/serethwyn-tor.md>).

### Tuesday, May 25th, 2 Robert I

The next morning is a fine spring day, a beautiful day of uneventful travel on the moors. The party camps in the foothills of [Westcliff](<../../gazetteer/greater-sembara/addermarch/westcliff.md>) in preparation for the climb to [Serethwyn Tor](<../../gazetteer/greater-sembara/addermarch/serethwyn-tor.md>) the next day.
