...
- [Elven Shadow Breastplate](<treasure/gifts-and-heirlooms/elven-shadow-breastplate.md>), given to Umli in [Session 74 (DuFr)](<session-notes/session-74-dufr.md>), who removed and blanked the Inkaye that had powered it, leaving a mundane breastplate
...
- [Ever Spinning Top](<treasure/treasure-from-agata/ever-spinning-top.md>). Stolen by M-F Chardonians. Retrieved in [Session 73 (DuFr)](<session-notes/session-73-dufr.md>)
