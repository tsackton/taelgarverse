...
- [Eidrikas](<../../../people/sembarans/eidrikas.md>) (*AYD-ree-kahs*; he/him): injured mentor and caretaker.
...
- [Great Chasm](<../../../gazetteer/greater-sembara/zimkova/great-chasm.md>) (chasm in [Zimkova](<../../../gazetteer/greater-sembara/zimkova/zimkova.md>), [Greater Sembara](<../../../gazetteer/greater-sembara/greater-sembara.md>)): immense chasm and ancient mechanism site where [Eidrikas](<../../../people/sembarans/eidrikas.md>) holds a damaged runic platform together while the party descends after the stolen stabilizing stone. Session context includes: floating rock beside Eidrikas's tilted runic platform above the suspended cylindrical structure.
- [Great Chasm](<../../../gazetteer/greater-sembara/zimkova/great-chasm.md>) suspended structure: broken multi-level structure beneath Eidrikas's platform, containing warped gravity, a damaged custodian, dangerous lightning systems, and the ruined chamber where the orcs gather. Session context includes: climbing out, repositioning the floating stone, and and opening the last hatch into the larger lower section.

## Narrative

The approach leaves the party suspended beside Eidrikas's damaged platform, with the [Great Chasm](<../../../gazetteer/greater-sembara/zimkova/great-chasm.md>) below and the cylindrical mechanism hanging beneath the broken runic array. [Ekko](<../../../people/pcs/other-pcs/into-the-chasm/ekko.md>) confirms Eidrikas's identity, [Eidrikas](<../../../people/sembarans/eidrikas.md>) describes the battle that let the orcs steal the black stone, and the group commits to pursuing the survivors before the force coursing through the machinery overwhelms him.

With [Eidrikas](<../../../people/sembarans/eidrikas.md>) still holding the mechanism above them, they shift from the exposed platform into the upper chamber of the suspended structure. Careful experiments around the blue column reveal how quickly the room's gravity can turn lethal, so they recover the hanging rope, avoid the fate of the smashed orc, and work their way through the cracked floors toward the next level.

The party lands in a more complex middle chamber and finds one automaton still intact enough to answer questions. [Finnan](<../../../people/pcs/other-pcs/into-the-chasm/finnan-oakstride.md>) presses it for a way to stabilize the structure or repair the damage, but the custodian offers only rigid fragments of procedure, leaving the party with no useful alternative to continuing after the orcs.
