...
- Jan 27, 1730 DR, midday: Malquin grants passage only after demanding proof that the outside world is real.
- Jan 27, 1730 DR - Jan 29, 1730 DR: [Eidrikas](<../../../people/sembarans/eidrikas.md>) holds the failing chasm mechanism together after [orcs](<../../../creatures/species/orcs.md>) steal its missing stone.

## Cast of Characters

- [Kalima](<../../../people/sembarans/kalima.md>) (she/her, the Zimka human): hidden guest.
- Zahara: secret guide in the whiteout.
- Samir: wakeful baby.
- Nura: host and interpreter of village beliefs.
- Taquin: remembering soul speaking through Samir.
- Iskander: Zahara's contact in Melusa.
- Ice wolf guardian: watcher at the safe gash.
- Malquin the Vaqar: ruler of the demiplane.
- [Eidrikas](<../../../people/sembarans/eidrikas.md>) (*AYD-ree-kahs*; he/him): druid holding the mechanism together.
- [Orcs](<../../../creatures/species/orcs.md>): fugitives below the mechanism.
- [Pakrinek](<../../../people/sembarans/pakrinek.md>) (*PACK-ree-neck*; kenku): fallen kenku companion.

## Places

- Melusa (place Unknown): Isolated chasm-side village caught between Malquin's rule, Zahara's hidden resistance, and the dangerous gashes in the cliff. Session context includes: Nura and Khaled's house, the snowy lane outside, Iskander's hut near the cattle-island bridge, the cliffside gashes, and the safe gash below the Ice Palace.
- Ice Palace: Malquin's floating palace, reached by a conjured bridge and dominated by an unstable audience with its ruler. Session context includes: the entrance hall and throne-room-like audience chamber.
- [Great Chasm](<../../../gazetteer/greater-sembara/zimkova/great-chasm.md>) (chasm in [Zimkova](<../../../gazetteer/greater-sembara/zimkova/zimkova.md>), [Greater Sembara](<../../../gazetteer/greater-sembara/greater-sembara.md>)): The true chasm beyond Melusa, where floating carved platforms surround a failing planar mechanism. Session context includes: arrival cliff face, movable floating stone, carved platform network, and damaged mechanism site.

## Narrative

The party's fragile refuge in Nura and Khaled's cramped house breaks when [Jrain](<../../../people/pcs/other-pcs/into-the-chasm/jrain-fanlish.md>) hears the door open during her watch. [Kalima](<../../../people/sembarans/kalima.md>) slips out with the guide later identified as Zahara while Malquin's soldiers move through the village, and Samir lies awake watching the escape. With the whiteout hiding both [Kalima](<../../../people/sembarans/kalima.md>) and the patrols, the party lets the moment pass, remains concealed, and finishes the long rest.
...
With Iskander's information exhausted, the party chooses action over more quiet investigation. They ask him to warn Zahara's circle that confronting Malquin may create an opening, then move to the cliffside gashes where the ice wolf watches the safe passage. [Eolo](<../../../people/pcs/other-pcs/into-the-chasm/eolo.md>) tests the metal gash and comes away with a sharp, shimmering fragment and a mangled arm, proving the other cracks are dangerous. The party then announces itself in Sylvan and illusion, drawing enough attention for the bridge to the Ice Palace to form.
...
Malquin's permission proves real enough for the ice wolf to let them approach, and the party prepares for the unknown by tying a rope around its leg before jumping through the gash. The portal opens onto a sheer cliff in the true [Great Chasm](<../../../gazetteer/greater-sembara/zimkova/great-chasm.md>), where carved floating platforms hang above a larger mechanism streaked with unstable light while new tears split the sky. [Eolo](<../../../people/pcs/other-pcs/into-the-chasm/eolo.md>) and [Ekko](<../../../people/pcs/other-pcs/into-the-chasm/ekko.md>) help the others reach the stones, and clairvoyance points them to [Eidrikas](<../../../people/sembarans/eidrikas.md>), alive but in agony as he uses his body to complete the damaged circuit. He tells them that [orcs](<../../../creatures/species/orcs.md>) overran the site, killed [Pakrinek](<../../../people/sembarans/pakrinek.md>), and carried a vital stone down through the platform network. His count of days also reveals that four extra days passed outside while the party was trapped in Melusa, leaving only a narrow window to recover the stolen piece.
