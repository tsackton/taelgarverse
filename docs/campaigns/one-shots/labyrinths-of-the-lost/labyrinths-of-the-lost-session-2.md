...
>[!info] The Chapel Route: in which a ghost points below
> *Featuring: Acescale, Gaudin, Loria, Dilion*
> *In Taelgar: Oct 17, 1748 DR to Oct 18, 1748 DR*
> *On Earth: Saturday, November 25, 2023*
> *Perdoli Manor, smithy grounds, formal garden edge near the chapel, chapel crypt, and hidden private archive*

After resting at the smithy, the party crosses Perdoli Manor by stealth, defeats two hobgoblins in the chapel crypt, finds hidden records and a chained basilisk, and learns from J.M.'s ghost that Grimstone's lair lies beneath the manor.

# Timeline

- Oct 17, 1748 DR - Oct 18, 1748 DR: The party rests in the smithy and chooses the chapel route.
- Oct 18, 1748 DR, dawn: The chapel approach ends with two dead hobgoblins in the crypt.
- Oct 18, 1748 DR, morning: The search through the manor reveals Grimstone's path below.

## Cast of Characters

- shadowy hobgoblin patrol: outer wall patrol.
- barracks goblins: nearby manor guards.
- petrified Medusa: statue in the formal garden.
- hobgoblin smokebinder: shadow-bound scout.
- hobgoblin guard: second patrol member.
- basilisk: chained creature in the central courtyard.
- goblin drill squad: guard post beyond the gallery door.
- J.M.: mourning sailor ghost.
- Folcan: released goblin informant.
- Grimstone: masked master inside the manor.
- patrolling hobgoblin: outer manor patrol.
- Petrona: woman in the locket.

## Places

- Perdoli Manor: ruined manor estate in [Western Cymea](<../../../gazetteer/western-green-sea/realms/western-cymea.md>) occupied by goblins, hobgoblins, chained monsters, and Grimstone's hidden operation. Session context includes: abandoned smithy prison room and nearby grounds.
- smithy grounds: outer workshop grounds used as the party's shelter before the dawn crossing toward the chapel. Session context includes: stealthy dawn crossing through overgrown vineyards and hedges.
- formal garden edge near the chapel: overgrown garden approach near the ruined chapel, with hedges, statues, and access toward the old fountain. Session context includes: stealthy dawn crossing through overgrown vineyards and hedges.
- chapel crypt: family crypt beneath the ruined chapel, used by the party for the hobgoblin ambush and linked to a hidden tunnel. Session context includes: secret tunnel under the manor.
- hidden private archive: sealed private archive inside the manor preserving Perdoli records, portraits, and a concealed bookcase mechanism. Session context includes: secret tunnel under the manor.
...
The first hobgoblin through the trapdoor is the same shadow-bound scout that chased the steampup, and the party's setup catches it immediately. It slips on the greased stairs, falls into the snare, and is hammered by Loria, Acescale, Gaudin, and the steampup until the steel defender throws it down for good. Dilion recognizes it as a smokebinder, its shadow cloak more ritual effect than loot, and the party turns the same trap into a lure for the next patrol member. The second hobgoblin also comes down into the stairs, wounds Gaudin with a crossbow and alchemist's fire, and dies before the alarm can spread.
