...
- :octicons-info-24:{ .lg .middle } __Biographical Information__
    ...
    Member of the Society of the Open Scroll (until March 18th, 1748)  
    { .bio }

    Lived in Chardon, the Chardonian Empire
</div>
...
One of the adventurers of the Society of the Open Scroll. Traveled with Dee Wildcloak and [Dain Goldhammer](<../dwarves/dain-goldhammer.md>) to [Stormcaller Tower](<../../gazetteer/greater-dunmar/dunmari-basin/stormcaller-tower.md>), where he was killed. 
