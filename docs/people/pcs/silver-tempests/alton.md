...
When Alton heard that the [Great Library](<../../../gazetteer/greater-chardon/chardonian-empire/chardon/great-library.md>) was recruiting adventurers to search for treasure and lost knowledge, he returned to [Chardon](<../../../gazetteer/greater-chardon/chardonian-empire/chardon/chardon.md>) and joined up. He was sent north, where he briefly joined [Samso](<./samso.md>), [Adrik](<./adrik.md>), and [Brelith](<./brelith.md>) to recover a scroll from some [Kobolds](<../../../creatures/species/kobolds.md>). However, he did not stay with them, and instead wandered a bit, doing a variety of odd jobs for the [Great Library](<../../../gazetteer/greater-chardon/chardonian-empire/chardon/great-library.md>), especially focusing on tasks that required stealth and subtlety.

Nearly a year later, in March of DR 1748, Alton joined a group of adventurers, including [Cassia](<../../chardonians/cassia.md>), a human paladin, and [Brottor](<../../dwarves/brottor.md>), a dwarf, to investigate the depths of the ruined mines under [Goldpeak Mountain](<../../../gazetteer/northwest-coast/fiamatara-mountains/goldpeak-mountain.md>). During the mission, [Brottor](<../../dwarves/brottor.md>) was killed by minions of Vilaxes, and Alton and Cassia only survived because of the [Silver Tempests](<./silver-tempests.md>), who found them and joined forces to defeat Vilaxes. 
