...
![Candrosa Portrait](/taelgarverse/assets/candrosa-portrait.webp){align="right"; width="400"}Candrosa serves as Speaker of the [Shakun Mystai](<../../groups/dunmari-mystery-cults/shakun-mystai.md>), acting as the leader of the [Temple of Shakun](<../../gazetteer/greater-dunmar/realms/dunmar/eastern-dunmar/temple-of-shakun.md>) in [Karawa](<../../gazetteer/greater-dunmar/realms/dunmar/eastern-dunmar/karawa.md>) and the public face of the mystai. He oversees rites, initiations, and dream-visions; and serves as a councilor to the temple hierarchy in Karawa. 
## Personality & Outlook
...
The loss of the [Heart of Shakun](<../../things/artifacts-of-power/heart-of-shakun.md>) exposed a streak of desperate improvisation: he will risk trust, even [manipulating visions](<../../campaigns/dunmari-frontier-campaign/session-notes/session-26-dufr.md>) if the alternative is watching the mesa crumble. Since the Heart’s recovery he is humbler, quicker to confer with allies, and intent on rebuilding a wider circle of initiates.
