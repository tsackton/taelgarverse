...
Godfrey runs a dairy farm on the outskirts of [Fontwick](<../../gazetteer/greater-sembara/addermarch/fontwick.md>) with his wife [Samantha of Fontwick](<samantha-of-fontwick.md>), supplying cheese and milk to markets as far as [Roscombe](<../../gazetteer/greater-sembara/addermarch/roscombe.md>). When an ankheg devastated their herd, Godfrey rode hard for Lady [Elowen Duval](<elowen-duval.md>)’s aid, crossing paths with the [Addermarch Mercenaries](<../pcs/addermarch/addermarch-mercenaries.md>) who ultimately slew the creature.
