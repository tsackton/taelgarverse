...
![Perrin Du Bois](../../assets/perrin-du-bois.png){align="right"; width="400"}Perrin is an Aurbeze beekeeper, father of four, and smallholder, elected to represent the scattered smallholds and isolated farms across the [Aurbez Plateau](<../../gazetteer/upper-istaros/aurbez-plateau.md>) in Alliance councils. 
...
## Events
- Aug 07, 1749 DR: Joined the war council at [Three Wells](<../../gazetteer/upper-istaros/refounded-alliance-of-aurbez/three-wells.md>), where he cautioned against plans that gambled civilian safety on uncertain outcomes, while acknowledging the need to protect the Heartroot.
