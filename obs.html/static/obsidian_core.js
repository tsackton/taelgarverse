...
var gzip_hash = '273025968013452220791447731556063475366'                       // used to check whether the localStorage data is stale
...
function get_html_url_prefix(){
    return '/taelgarverse'  // this value is replaced by the actual url prefix when compiled
}
